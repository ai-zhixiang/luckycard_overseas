...
(function() {
        ...
        var menu = {
            ...
            printers: function() {
                return '<div style="padding:16px;font-family:Tahoma,sans-serif">' +
                    ...
                    '<button onclick="XPShell.openWindow(\'create\',\'Create Card\',\'<img src=\"/static/img/xp-ie6_20.png?v=1\" style=\"width:20px;height:20px;vertical-align:middle\">\',\'' + '/static/forms/card-create.html' + '\')" style="width:100%;padding:8px;font-size:12px;cursor:pointer;border:1px solid #999;background:linear-gradient(180deg,#fff,#ece9d8);border-radius:3px;margin-bottom:8px"><img src="/static/img/xp-ie6_20.png?v=1" style="width:20px;height:20px;vertical-align:middle"> Create a New Card</button>' +
                    '<button onclick="XPShell.openWindow(\'gallery\',\'Gallery\',\'<img src=\"/static/img/xp-gallery_20.png?v=1\" style=\"width:20px;height:20px;vertical-align:middle\">\',\'' + '/static/forms/card-gallery.html' + '\')" style="width:100%;padding:8px;font-size:12px;cursor:pointer;border:1px solid #999;background:linear-gradient(180deg,#fff,#ece9d8);border-radius:3px"><img src="/static/img/xp-gallery_20.png?v=1" style="width:20px;height:20px;vertical-align:middle"> View Card Gallery</button></div>';
            },
            accounts: function() {
                return '<div style="padding:16px;font-family:Tahoma,sans-serif">' +
    ...
    window._initCmdWindow = function _initCmdWindow() {
